...
/**
 * Replace article polaroid cover with a client-edited still
 * (rotate / crop done in the browser, then uploaded here).
 */
export async function POST(req: NextRequest, ctx: Ctx) {
  ...
  try {
    ...
    const storageKey = `articles/${id}/cover/${randomUUID()}.jpg`;
    ...
    await updateArticle(id, { coverImage });
